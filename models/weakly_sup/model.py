...
def build(nc, w, h,cfg):
    ...
    conv_final = Conv2D(nc, (1, 1))(unet_2)
    ...
    label_branch=Label_branch.build(WoundSkin,conv_final)
    ...
    model = Model(inputs=[tissue_inp,weakly_inp,WoundSkin],outputs=[seg_branch,weakly_branch,label_branch])
